...
export function DataTablePagination<TData>({ table, className }: DataTablePaginationProps<TData>) {
	...
	return (
		<div className={cn('flex items-center justify-between overflow-clip px-2', className)}>
			<div className="flex w-full items-center justify-between">
				...
				<div className="flex items-center gap-2">
					...
					<p className="hidden lg:block text-sm">Rows per page</p>
				</div>
			</div>

			<div className="flex items-center space-x-2 ml-0 lg:ml-6">
				<Button
					variant="outline"
